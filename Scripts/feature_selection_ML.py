# -*- coding: utf-8 -*-
"""THCA_SVC-L1_20.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1aAjcF_VpiEQMnCUa2CXkrTuNIMRh_lyd
"""

import pandas as pd
import numpy as np
df = pd.read_csv('/content/Z_scaling_THCA_data_1.csv')
df
...
"""For calcuting AUC for each Class"""

import pandas as pd
import numpy as np
df = pd.read_csv('/content/X_test_data_20_imp_6th (1).csv')
df
# Convert to NumPy array
X_test_selected = df.values
print(X_test_selected)

df1 = pd.read_csv('/content/X_train_data_20_imp_6th (1).csv')
df1
# Convert to NumPy array
X_train_selected = df1.values
print(X_train_selected)

y_train = pd.read_csv('/content/y_train_20_6th (1).csv')
y_train

y_test = pd.read_csv('/content/y_test_20_6th (1).csv')
y_test
...
results_df.to_csv('svc-l1_20_imp_single.csv', index=False)

from google.colab import files

# Save results_df to a CSV file
results_df.to_csv('svc-l1_20_imp.csv', index=False)
...
"""**Ensemble models for second set of biomarkers AUC=0.95**"""

## add X_train_selected, X_test_selected, y_train and y_test##
...
# Save results_df to a CSV file
results_df.to_csv('svc-l1_20_voting_2nd_imp.csv', index=False)

# Download the CSV file
files.download('svc-l1_20_voting_2nd_imp.csv')
...
meta_classifier = SVC(probability=True, random_state=42, C=10, kernel='rbf', gamma='auto')
...
# Save results_df to a CSV file
results_df.to_csv('svc-l1_20_stacking_2nd_imp.csv', index=False)

# Download the CSV file
files.download('svc-l1_20_stacking_2nd_imp.csv')